...
class _$FormatExceptionImpl implements FormatException {
  ...
  @override
  String toString() {
    return 'NetworkException.formatException(message: $message)';
  }
...
abstract class FormatException implements NetworkException {
  const factory FormatException({final String? message}) =
      _$FormatExceptionImpl;
...
class _$UnableToProcessImpl implements UnableToProcess {
  const _$UnableToProcessImpl({this.message});
  ...
  @override
  String toString() {
    return 'NetworkException.unableToProcess(message: $message)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return unableToProcess(message);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return unableToProcess?.call(message);
  }
...
abstract class UnableToProcess implements NetworkException {
  const factory UnableToProcess({final String? message}) =
      _$UnableToProcessImpl;
...
class _$DefaultErrorImpl implements DefaultError {
  const _$DefaultErrorImpl({required this.error, this.statusCode});
  ...
  @override
  String toString() {
    return 'NetworkException.defaultError(error: $error, statusCode: $statusCode)';
  }
...
class _$UnexpectedErrorImpl implements UnexpectedError {
  ...
  @override
  String toString() {
    return 'NetworkException.unexpectedError(message: $message)';
  }
